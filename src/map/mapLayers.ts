...
export const mapLayers: MapLayerData[] = [
  ...
  rasterBase('swisstopo-raster', 'Swisstopo Raster', ['https://wmts.geo.admin.ch/1.0.0/ch.swisstopo.pixelkarte-farbe/default/current/3857/{z}/{x}/{y}.jpeg'], '© swisstopo', 300, 'countries', false, 19, 'readableTopo', 'fragile', 128, 'switzerland'),
  vectorBase('swisstopo-vector', 'Swisstopo Vector', 'https://vectortiles.geo.admin.ch/styles/ch.swisstopo.basemap.vt/style.json', '© swisstopo', 305, 'countries', false, 'readableTopo', 'fragile', 'switzerland'),
  vectorBase('swisstopo-satellite', 'Swisstopo Satellite', 'https://vectortiles.geo.admin.ch/styles/ch.swisstopo.imagerybasemap.vt/style.json', '© swisstopo', 306, 'countries', false, 'satelliteForTracks', 'fragile', 'switzerland'),
  vectorBase('linz', 'LINZ Topographic', 'https://basemaps.linz.govt.nz/v1/styles/topographic-v2.json?api=d01fbtg0ar23gctac5m0jgyy2ds', '© LINZ CC BY 4.0', 308, 'countries', false, 'readableTopo', 'fragile', 'new-zealand'),
  rasterBase('linz-topo', 'LINZ Topo Raster', ['https://basemaps.linz.govt.nz/v1/tiles/topo-raster/WebMercatorQuad/{z}/{x}/{y}.webp?api=d01fbtg0ar23gctac5m0jgyy2ds'], '© LINZ CC BY 4.0', 310, 'countries', false, 16, 'readableTopo', 'fragile', 256, 'new-zealand'),
  rasterBase('ign-belgium', 'IGN Belgium', ['https://cartoweb.wmts.ngi.be/1.0.0/topo/default/3857/{z}/{y}/{x}.png'], '© IGN/NGI', 320, 'countries', false, 17, 'readableTopo', 'fragile', 256, 'belgium'),
  vectorBase('ign-fr-plan', 'IGN France Plan', '/map-styles/ign-fr-plan.json', 'IGN-F/Géoportail', 325, 'countries', false, 'readableTopo', 'fragile', 'france'),
  vectorBase('ign-fr-topo', 'IGN France Topo', '/map-styles/ign-fr-topo.json', 'IGN-F/Géoportail', 326, 'countries', false, 'readableTopo', 'fragile', 'france'),
  rasterBase('ign-fr-scan25', 'IGN France Scan 25', ['https://data.geopf.fr/private/wmts?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&TILEMATRIXSET=PM&TILEMATRIX={z}&TILECOL={x}&TILEROW={y}&LAYER=GEOGRAPHICALGRIDSYSTEMS.MAPS.SCAN25TOUR&FORMAT=image/jpeg&STYLE=normal&apikey=ign_scan_ws'], 'IGN-F/Géoportail', 330, 'countries', false, 16, 'readableTopo', 'fragile', 256, 'france'),
  vectorBase('ign-fr-satellite', 'IGN France Satellite', '/map-styles/ign-fr-satellite.json', 'IGN-F/Géoportail', 335, 'countries', false, 'satelliteForTracks', 'fragile', 'france'),
  rasterBase('ign-spain', 'IGN Spain', ['https://www.ign.es/wmts/mapa-raster?layer=MTN&style=default&tilematrixset=GoogleMapsCompatible&Service=WMTS&Request=GetTile&Version=1.0.0&Format=image/jpeg&TileMatrix={z}&TileCol={x}&TileRow={y}'], '© IGN Spain', 340, 'countries', false, 20, 'readableTopo', 'fragile', 256, 'spain'),
  ...
  vectorBase('ordnance-survey', 'Ordnance Survey', 'https://api.os.uk/maps/vector/v1/vts/resources/styles?srs=3857&key=piCT8WysfuC3xLSUW7sGLfrAAJoYDvQz', '© Ordnance Survey', 355, 'countries', false, 'readableTopo', 'fragile', 'united-kingdom'),
  rasterBase('norway-topo', 'Norway Topo', ['https://cache.kartverket.no/v1/wmts/1.0.0/topo/default/webmercator/{z}/{y}/{x}.png'], '© Geonorge', 360, 'countries', false, 20, 'readableTopo', 'fragile', 256, 'norway'),
  rasterBase('finland-topo', 'Finland Topo', ['https://avoin-karttakuva.maanmittauslaitos.fi/avoin/wmts?layer=maastokartta&style=default&tilematrixset=WGS84_Pseudo-Mercator&Service=WMTS&Request=GetTile&Version=1.0.0&Format=image/png&TileMatrix={z}&TileCol={x}&TileRow={y}&api-key=30cb768c-c968-493c-ae24-2b0b974ebd29'], '© Maanmittauslaitos', 370, 'countries', false, 18, 'readableTopo', 'fragile', 256, 'finland'),
  rasterBase('bg-mountains', 'BG Mountains', ['https://bgmtile.kade.si/{z}/{x}/{y}.png'], '© BG Mountains', 380, 'countries', false, 19, 'readableTopo', 'fragile', 256, 'bulgaria'),
  rasterBase('usgs', 'USGS Topo', ['https://basemap.nationalmap.gov/arcgis/rest/services/USGSTopo/MapServer/tile/{z}/{y}/{x}?blankTile=false'], '© USGS', 390, 'countries', false, 16, 'readableTopo', 'fragile', 256, 'united-states'),
  ...
  vectorOverlay('bikerouter-gravel', 'BRouter Gravel', '/map-styles/bikerouter-gravel.json', '© BRouter, © OpenStreetMap contributors', 1055, 'routes', false, 0.8, 'fragile'),
  ...
  rasterOverlay('swisstopo-slope', 'Swisstopo Slope > 30°', ['https://wmts.geo.admin.ch/1.0.0/ch.swisstopo.hangneigung-ueber_30/default/current/3857/{z}/{x}/{y}.png'], '© swisstopo', 1300, 'country-overlays', false, 0.4, 'fragile', 'switzerland'),
  rasterOverlay('swisstopo-hiking', 'Swisstopo Hiking', ['https://wmts.geo.admin.ch/1.0.0/ch.swisstopo.swisstlm3d-wanderwege/default/current/3857/{z}/{x}/{y}.png'], '© swisstopo', 1310, 'country-overlays', false, 0.8, 'fragile', 'switzerland'),
  rasterOverlay('swisstopo-hiking-closures', 'Swisstopo Hiking Closures', ['https://wms.geo.admin.ch/?version=1.3.0&service=WMS&request=GetMap&sld_version=1.1.0&layers=ch.astra.wanderland-sperrungen_umleitungen&format=image/png&STYLE=default&bbox={bbox-epsg-3857}&width=256&height=256&crs=EPSG:3857&transparent=true'], '© swisstopo', 1315, 'country-overlays', false, 0.8, 'fragile', 'switzerland'),
  rasterOverlay('swisstopo-cycling', 'Swisstopo Cycling', ['https://wmts.geo.admin.ch/1.0.0/ch.astra.veloland/default/current/3857/{z}/{x}/{y}.png'], '© swisstopo', 1320, 'country-overlays', false, 0.8, 'fragile', 'switzerland'),
  rasterOverlay('swisstopo-cycling-closures', 'Swisstopo Cycling Closures', ['https://wms.geo.admin.ch/?version=1.3.0&service=WMS&request=GetMap&sld_version=1.1.0&layers=ch.astra.veloland-sperrungen_umleitungen&format=image/png&STYLE=default&bbox={bbox-epsg-3857}&width=256&height=256&crs=EPSG:3857&transparent=true'], '© swisstopo', 1325, 'country-overlays', false, 0.8, 'fragile', 'switzerland'),
  rasterOverlay('swisstopo-mtb', 'Swisstopo MTB', ['https://wmts.geo.admin.ch/1.0.0/ch.astra.mountainbikeland/default/current/3857/{z}/{x}/{y}.png'], '© swisstopo', 1330, 'country-overlays', false, 0.8, 'fragile', 'switzerland'),
  rasterOverlay('swisstopo-mtb-closures', 'Swisstopo MTB Closures', ['https://wms.geo.admin.ch/?version=1.3.0&service=WMS&request=GetMap&sld_version=1.1.0&layers=ch.astra.mountainbikeland-sperrungen_umleitungen&format=image/png&STYLE=default&bbox={bbox-epsg-3857}&width=256&height=256&crs=EPSG:3857&transparent=true'], '© swisstopo', 1335, 'country-overlays', false, 0.8, 'fragile', 'switzerland'),
  rasterOverlay('swisstopo-ski-touring', 'Swisstopo Ski Touring', ['https://wmts.geo.admin.ch/1.0.0/ch.swisstopo-karto.skitouren/default/current/3857/{z}/{x}/{y}.png'], '© swisstopo', 1340, 'country-overlays', false, 0.8, 'fragile', 'switzerland'),
  rasterOverlay('ign-fr-cadastre', 'IGN France Cadastre', ['https://data.geopf.fr/wmts?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&TILEMATRIXSET=PM&TILEMATRIX={z}&TILECOL={x}&TILEROW={y}&LAYER=CADASTRALPARCELS.PARCELS&FORMAT=image/png&STYLE=normal'], 'IGN-F/Géoportail', 1350, 'country-overlays', false, 0.5, 'fragile', 'france'),
  rasterOverlay('ign-fr-slope', 'IGN France Slope', ['https://data.geopf.fr/wmts?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&TileMatrixSet=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&Layer=GEOGRAPHICALGRIDSYSTEMS.SLOPES.MOUNTAIN&FORMAT=image/png&Style=normal'], 'IGN-F/Géoportail', 1360, 'country-overlays', false, 0.4, 'fragile', 'france'),
  rasterOverlay('ign-fr-ski-touring', 'IGN France Ski Touring', ['https://data.geopf.fr/wmts?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&TileMatrixSet=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&Layer=TRACES.RANDO.HIVERNALE&FORMAT=image/png&Style=normal'], 'IGN-F/Géoportail', 1370, 'country-overlays', false, 0.8, 'fragile', 'france'),
]
...
function vectorBase(id: string, title: string, styleUrl: string, attribution: string, order: number, groupId: string, defaultVisible: boolean, visualProfileId: string, reliability: MapLayerReliability = 'normal', subgroupId?: string): VectorBaseLayerData {
  return { id, title, kind: 'vector-base', role: 'base', sourceType: 'vector', groupId, subgroupId, order, styleUrl, attribution, defaultOpacity: 1, visualProfileId, reliability, defaultVisible }
}

function rasterBase(id: string, title: string, tiles: string[], attribution: string, order: number, groupId: string, defaultVisible: boolean, maxzoom: number, visualProfileId: string, reliability: MapLayerReliability = 'normal', tileSize = 256, subgroupId?: string): RasterBaseLayerData {
  return { id, title, kind: 'raster-base', role: 'base', sourceType: 'raster', groupId, subgroupId, order, style: rasterStyle(id, tiles, attribution, maxzoom, tileSize), attribution, defaultOpacity: 1, visualProfileId, reliability, defaultVisible }
}

function rasterOverlay(id: string, title: string, tiles: string[], attribution: string, order: number, groupId: string, defaultVisible: boolean, defaultOpacity: number, reliability: MapLayerReliability = 'normal', subgroupId?: string): RasterOverlayLayerData {
  return { id, title, kind: 'raster-overlay', role: 'overlay', sourceType: 'raster', groupId, subgroupId, order, style: rasterStyle(id, tiles, attribution, 18), attribution, defaultOpacity, visualProfileId: 'cleanRaster', reliability, defaultVisible }
}

function vectorOverlay(id: string, title: string, styleUrl: string, attribution: string, order: number, groupId: string, defaultVisible: boolean, defaultOpacity: number, reliability: MapLayerReliability = 'normal', subgroupId?: string): VectorOverlayLayerData {
  return { id, title, kind: 'vector-overlay', role: 'overlay', sourceType: 'vector', groupId, subgroupId, order, styleUrl, attribution, defaultOpacity, visualProfileId: 'cleanRaster', reliability, defaultVisible }
}
