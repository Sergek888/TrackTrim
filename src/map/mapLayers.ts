...
export type MapLayerSourceType = 'raster' | 'hillshade'
...
export const mapLayers: MapLayerData[] = [
  rasterBase('osm', 'OpenStreetMap', ['https://a.tile.openstreetmap.org/{z}/{x}/{y}.png', 'https://b.tile.openstreetmap.org/{z}/{x}/{y}.png', 'https://c.tile.openstreetmap.org/{z}/{x}/{y}.png'], '© OpenStreetMap contributors', 100, 'base', true, 19, 'cleanRaster'),
...
export const mapLayerGroups: MapLayerGroupData[] = [
  ...
  { id: 'activity', title: 'Следы активности', order: 800 },
