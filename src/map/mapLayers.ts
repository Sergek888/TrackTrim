...
export type MapLayerKind = 'raster-base' | 'vector-base' | 'raster-overlay' | 'terrain'
...
export type MapLayerData = RasterBaseLayerData | VectorBaseLayerData | RasterOverlayLayerData | TerrainLayerData
...
export const mapLayers: MapLayerData[] = [
  vectorBase('liberty-topo', 'Liberty Topo', 'https://styles.gpx.studio/liberty-topo.json', '© GPX Studio, © OpenStreetMap contributors', 80, 'topo', true, 'readableTopo'),
  vectorBase('liberty-satellite', 'Liberty Satellite', 'https://styles.gpx.studio/liberty-satellite.json', '© GPX Studio, © OpenStreetMap contributors', 90, 'satellite', true, 'satelliteForTracks'),
  ...
  vectorBase('utagawa-vtt', 'UtagawaVTT', 'https://maps.utagawavtt.com/styles/utagawavtt/style.json', '© UtagawaVTT, © OpenStreetMap contributors', 135, 'activity', false, 'readableTopo', 'fragile'),
  ...
  terrainLayer('mapterhorn-hillshade', 'Mapterhorn Hillshade', 'https://tiles.mapterhorn.com/tilejson.json', '© Mapterhorn', 700, 'relief', false, 0.18, 'normal'),
